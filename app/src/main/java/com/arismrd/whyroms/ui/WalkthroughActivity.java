...
public class WalkthroughActivity extends FancyWalkthroughActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FancyWalkthroughCard fancywalkthroughCard1 = new FancyWalkthroughCard("Temukan Custom ROM", "Pilihan Custom ROM terbaik untuk ponsel Xiaomi.",R.drawable.ic_home);
        FancyWalkthroughCard fancywalkthroughCard2 = new FancyWalkthroughCard("Codename Xiaomi", "Memudahkan pemula untuk melihat codename ponselnya.",R.drawable.ic_device);
        FancyWalkthroughCard fancywalkthroughCard3 = new FancyWalkthroughCard("Tutorial Video", "Kumpulan tutorial seputar dunia oprek Android yang dapat ditonton langsung.",R.drawable.ic_rom);
